...
public extension Color {
  static let asp_background = _Asset.Colors.background.color
  static let asp_primary = _Asset.Colors.primary.color
}

public extension Image {
  static let asp_launchScreen = _Asset.Images.launchScreen.image
}
